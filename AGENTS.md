...
9. Remotion Video Producer builds a timeline sync plan, then assembles the full timeline, captions/subtitles, audio, transitions, visual debugging evidence, render release candidate, and technical render QA evidence using local Remotion `public/` assets tracked by the media asset manifest.
