...
Own full Remotion video assembly, usually 1-10 minutes: timeline composition, captions, subtitles, voice/music/SFX mix, post-production passes, render release candidates, and final QA. This agent consumes scene candidates and Remotion clip packages instead of producing every clip itself.
...
- Preview/render commands, output paths, and QA report
...
- Validate subtitles, audio sync, scene ordering, transitions, export settings, and final render health.
