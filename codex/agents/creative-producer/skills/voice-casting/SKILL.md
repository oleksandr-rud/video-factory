...
- Provider constraints when known: language support, accent labels, voice categories, inventory availability, and generation policy
...
3. Select voice attributes that support the video goal and channel continuity: narrator persona, authority level, warmth, energy, seriousness, humor, urgency, emotional distance, language, accent policy, age range when relevant, gender or neutral preference, pace, pauses, and scene-level energy.
