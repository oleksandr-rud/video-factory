...
1. Read every scene in the scenario, plus any reference analysis and channel format package.
...
5. Add technical requirements: aspect ratio, minimum resolution, duration, people/product needs, and brand safety notes.
...
Return a visual pack matching `codex/contracts/scene-visual-pack.schema.json`.
