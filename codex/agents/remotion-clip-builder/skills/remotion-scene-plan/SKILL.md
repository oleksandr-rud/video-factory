...
2. Define props for copy, colors, assets, source media asset ids, `staticFile()` paths, and scene duration.
...
8. Define the fields needed for `codex/contracts/remotion-clip-package.schema.json`, including project/channel fields, media asset manifest path, Remotion project contract path, and output asset ids.
